...
| 13 September 2026 | Corrected the audit. Papers on file are 86, not 84, and 13 papers have no review rather than 11. Two earlier audits in the same folder were found and both are more detailed. The published claim of 73 papers with a review still holds, but it follows the looser definition that counts confirmation emails as covering a paper. The stricter definition gives 66, so which one the application rests on needs deciding. |
